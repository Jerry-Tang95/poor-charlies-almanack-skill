<!-- capability_id: cap.poor-charlies-almanack.deprival-superreaction | revision: 1 | status: active -->
<!-- 来源: poor-charlies-almanack/deprival-superreaction/SKILL.md（正文逐字保留） -->
...
**判停条件**：若用户此刻正处在"即将失去"的临界时刻（拍卖即将落槌、谈判正在僵持），终止现场分析，先直接叫停这次加价/让步动作，把决策推迟到冷却期后再做；若识别出这只是正常的风险规避而非被剥夺超级反应，终止"纠偏"，不要为正常谨慎贴标签。
...
- 本书源自芒格 1986—2000 年代的演讲与文章、2005 年成书；贝尔里奇石油、公开竞拍等案例都发生在传统交易与拍卖场景，与 2026 年即时竞价平台、游戏化抽奖的诱导设计差异很大。
- 该倾向的论证是从芒格个人经历与伯克希尔"极端成功案例"归纳的，存在幸存者偏差：芒格自陈的 540 万美元教训只是一个样本，无法支撑对损失厌恶强度的普遍推断。
- "被剥夺超级反应"是芒格的个人定义，未经实验心理学验证，与行为经济学的"损失厌恶"并不完全等同，不能当心理诊断结论使用。
- 涉及具体投资决策时，本书给的是偏差预警框架，不构成投资建议。
...
## 相关能力
- **误判心理学清单**（cap.poor-charlies-almanack.misjudgment-psychology-checklist）：本能力是倾向十四的独立深度剖析，需先掌握 25 种倾向全景，才能看清它与避免不一致性、心理否认的交互作用。
