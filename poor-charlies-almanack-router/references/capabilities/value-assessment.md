<!-- capability_id: cap.poor-charlies-almanack.value-assessment | revision: 1 | status: active -->
<!-- 来源: poor-charlies-almanack/value-assessment/SKILL.md（正文逐字保留） -->
...
**判停条件**：若能力圈检验判定为"圈外"，终止后续估值，改由能力圈判断先给出行动方案，不在此处凭财务模型硬算内在价值；若既给不出安全边际的具体数字、也写不出任何"可能看错"的假设，停止出结论，降级为"仅提供分析框架、不出判断"。
...
- 对高科技/网络效应型企业的分析框架不够
- 本书源自芒格 1986—2000 年代的演讲与文章、2005 年成书；喜诗糖果、华盛顿邮报等案例的背景是美国纸质媒体与消费品牌的黄金时代，其护城河与定价权逻辑在 2026 年已被技术颠覆大幅改写。
- 该框架是从伯克希尔"极端成功案例"归纳的，存在幸存者偏差：书中几乎只回看赢家，缺少同期"同样便宜却继续下跌"的对照标的来检验安全边际的可靠性。
- 涉及具体投资决策时，本书给的是思维框架，不构成投资建议，也不接实时行情与财报原始数据。
...
## 相关能力
- **能力圈判断**（cap.poor-charlies-almanack.circle-of-competence）：能力圈检验是价值评估的第三步，在不理解的领域强行估算内在价值即是自欺欺人。
- **规模优势与劣势**（cap.poor-charlies-almanack.scale-advantage-analysis）：规模优势与网络效应是护城河判断的关键输入，为五维框架提供子维度分析。
