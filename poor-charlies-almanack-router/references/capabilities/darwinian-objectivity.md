<!-- capability_id: cap.poor-charlies-almanack.darwinian-objectivity | revision: 1 | status: active -->
<!-- 来源: poor-charlies-almanack/darwinian-objectivity/SKILL.md（正文逐字保留） -->
...
**判停条件**：若反面证据与随机噪声无法区分（如高噪声市场里的短期数据），终止继续取证，改为拉长观察窗口或寻找可重复的反例；若已穷尽可得的反面证据、结论仍成立，停止搜索以免无限证伪，并写明该结论"在什么条件下会被推翻"。
...
- 本书源自芒格 1986—2000 年代的演讲与文章、2005 年成书；达尔文、爱因斯坦与 FDA 双盲试验的例证都属科学史范畴，其"制度化证伪"的结论未随 2026 年可重复性危机等科学社会学进展更新。
- "极端客观性"是从芒格本人长期成功的生涯归纳的，存在幸存者偏差：善于自我证伪的人未必都被记录，也无法证明该习惯是成就的主因而非伴随特征。
- 涉及具体投资决策时，本书给的是检验观点的思维框架，不构成投资建议。
...
## 相关能力
- **逆向思维**（cap.poor-charlies-almanack.inversion-thinking）：逆向思维在构建解决方案时使用，本能力在验证已有结论时使用，两者阶段不同但互补衔接。
- **双轨分析**（cap.poor-charlies-almanack.dual-track-analysis）：双轨分析提供广角镜头，本能力在理性轨内部提供系统搜索反面证据的聚焦工具。
